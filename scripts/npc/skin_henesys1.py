# Ms. Tan (1012105) | Hair, Eyes and Skin Manager script

salonName = ["Tel Aviv", "Haifa", "Beer Sheva", "Kiryat Malachi", "Eilat"]

#listed by salons.
maleHairs = [[33040, 30060, 32350, 33170, 30210, 33100, 30610],[30320, 30330, 30150, 30900, 30170, 30180, 30820, 30410, 30460],[30350, 30760, 30330, 30560, 30040, 30730, 30470],[30130, 33040, 30850, 30780, 30040, 30920, 30860],[30250, 30190, 30660, 30870, 30840, 30160, 30640]]
...
text += "#L0#Hair#l\r\n#L1#Eyes#l\r\n#L2#Skin#l\r\n#L3#Hair Color#l\r\n#L4#Eye Color#l\r\n#r#L5#Nothing, I'm fine for now.#l"
